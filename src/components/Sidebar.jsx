...
import { Home, BookOpen, Users, FileText, ShoppingCart, Scissors, Grid, BarChart2, LogOut, FilePen } from 'lucide-react'
...
const menu = [
  ...
  { label: 'Contratos',    path: '/contratos',    icon: FilePen     },
...
export default function Sidebar({ onLogout, usuario }) {
  ...
  return (
    <div style={{ width: '200px', minWidth: '200px', backgroundColor: '#2D4A2D', display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <div style={{ padding: '1.25rem 1rem', borderBottom: '1px solid rgba(212,196,160,0.15)' }}>
        <p style={{ color: '#D4C4A0', fontSize: '15px', fontWeight: '700', lineHeight: '1.2' }}>Decoraciones<br />Gallito y Piedra</p>
      ...
      <div style={{ padding: '0.75rem', borderTop: '1px solid rgba(212,196,160,0.15)' }}>
        ...
        <button onClick={onLogout} style={{ width: '100%', padding: '9px 12px', borderRadius: '8px', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', backgroundColor: 'rgba(163,45,45,0.2)', color: '#f9a0a0', fontSize: '13px', fontWeight: '500' }}
